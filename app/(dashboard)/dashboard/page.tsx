...
import { ArrowDown, ArrowUp, Bitcoin, ChevronDown, DollarSign, LineChartIcon, Wallet, LineChart } from "lucide-react"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"
import { Button } from "@/components/ui/button"
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/components/ui/dropdown-menu"
import { ChartContainer, ChartTooltip, ChartTooltipContent } from "@/components/ui/chart"
import { Area, AreaChart, Bar, BarChart, Line, ResponsiveContainer, XAxis, YAxis } from "recharts"
            ...
            <Tabs defaultValue="btc" className="w-full">
              ...
              <TabsContent value="btc" className="space-y-4">
                <CryptoStats
                  ...
                  isPositive={true}
                />
                <CryptoChart color="hsl(var(--chart-1))" />
              </TabsContent>
              <TabsContent value="eth" className="space-y-4">
                <CryptoStats
                  ...
                  isPositive={true}
                />
                <CryptoChart color="hsl(var(--chart-2))" />
              </TabsContent>
              <TabsContent value="sol" className="space-y-4">
                <CryptoStats
                  ...
                  isPositive={true}
                />
                <CryptoChart color="hsl(var(--chart-3))" />
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <ChartTooltip
              content={<ChartTooltipContent formatValue={(value) => `$${Number(value).toLocaleString()}`} />}
            />
            <Area
              type="monotone"
              dataKey="value"
...
// This is needed for the Bar chart
